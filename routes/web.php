...
//Rutas con condicion de estar logueado

Route::middleware(['auth'])->group(function() {

	//ROLES

	//En post definimos la ruta, en name ponemos el nombre de la ruta y en el middleware le pasamos el permiso

	Route::post('roles/store', 'RoleController@store')->name('roles.store')->middleware('permission:roles.create'); //base
